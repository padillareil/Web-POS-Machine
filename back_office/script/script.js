$(document).ready(function() {
  ...
  // MENU CLICK HANDLER
  // =====================
  $("#main-menu a.nav-link[name='menu']").on("click", function(e) {
    ...
    $("#main-menu a.nav-link[name='menu']").removeClass("active");

    // Variables for AJAX content
    let $file = "";
    let $maintitle = "";
    let $mainbreadcrumb = "";
    ...
    switch (menucode) {
      ...
      case "branch_setup":
        $maintitle = "";
        $mainbreadcrumb = `<li class="breadcrumb-item active"></li>`;
        $file = "dirs/branch_setup/branch_setup.php";
        break;
      case "logs":
        $maintitle = "Logs";
        $mainbreadcrumb = `<li class="breadcrumb-item active"></li>`;
    ...
    $.post($file, function(data) {
      setTimeout(function() {
        $("#main-title").hide().html($maintitle).fadeIn(100);
        $("#main-breadcrumb").hide().html($mainbreadcrumb).fadeIn(100);
        $("#main-content").hide().html(data).fadeIn(100);
        $a.addClass("active");
      }, 100);
    });
  ...
  // =====================================
  // AUTO DISPLAY ACTIVE MENU CONTENT
  // =====================================
  $("#main-menu a.nav-link.active[name='menu']").trigger("click");
